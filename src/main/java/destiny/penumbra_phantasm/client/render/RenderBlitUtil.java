...
{
	public static void blit(ResourceLocation pAtlasLocation, PoseStack stack, float pX, float pY,
							float red, float green, float blue, float alpha,
							float pUOffset, float pVOffset, float pUWidth, float pVHeight) {
		RenderBlitUtil.blit(pAtlasLocation, stack, pX, pY,
				red, green, blue, alpha,
				0, pUOffset, pVOffset, pUWidth, pVHeight, 256, 256);
	}
	 ...
	 * @param green red color component [0; 1].
	 * @param blue red color component [0; 1].
	 * @param alpha red color component [0; 1].
	...
	public static void blit(ResourceLocation pAtlasLocation, PoseStack stack, float pX, float pY,
							float red, float green, float blue, float alpha,
							float pBlitOffset, float pUOffset, float pVOffset, float pUWidth, float pVHeight, float pTextureWidth, float pTextureHeight) {
		RenderBlitUtil.blit(pAtlasLocation, stack, pX, pX + pUWidth, pY, pY + pVHeight,
				red, green, blue, alpha,
				pBlitOffset, pUWidth, pVHeight, pUOffset, pVOffset, pTextureWidth, pTextureHeight);
	}
	...
	public static void blit(ResourceLocation pAtlasLocation, PoseStack stack, float pX, float pY,
		...
		RenderBlitUtil.blit(pAtlasLocation, stack, pX, pX + pWidth, pY, pY + pHeight,
				red, green, blue, alpha,
				0, pUWidth, pVHeight, pUOffset, pVOffset, pTextureWidth, pTextureHeight);
	}
	...
	public static void blit(ResourceLocation pAtlasLocation, PoseStack stack, float pX, float pY,
		...
		RenderBlitUtil.blit(pAtlasLocation, stack, pX, pY,
				red, green, blue, alpha,
				pWidth, pHeight, pUOffset, pVOffset, pWidth, pHeight, pTextureWidth, pTextureHeight);
	}
	 ...
	 * @param pTextureHeight the height of the texture.
	 */
	static void blit(ResourceLocation pAtlasLocation, PoseStack stack, float pX1, float pX2, float pY1, float pY2,
					 float red, float green, float blue, float alpha,
					 float pBlitOffset, float pUWidth, float pVHeight, float pUOffset, float pVOffset, float pTextureWidth, float pTextureHeight) {
		RenderBlitUtil.innerBlit(pAtlasLocation, stack, pX1, pX2, pY1, pY2,
				red, green, blue, alpha, pBlitOffset,
	 ...
	 */
	static void innerBlit(ResourceLocation pAtlasLocation, PoseStack pose, float pX1, float pX2, float pY1, float pY2,
						  float red, float green, float blue, float alpha,
	...
	public static void blitGui(GuiGraphics pGuiGraphics, ResourceLocation pAtlasLocation, int pX, int pY, int pUOffset, int pVOffset, int pUWidth, int pVHeight, float pRed, float pGreen, float pBlue, float pAlpha) {
		blitGui(pGuiGraphics.pose(), pAtlasLocation, pX, pY, 0, (float)pUOffset, (float)pVOffset, pUWidth, pVHeight, 256, 256, pRed, pGreen, pBlue, pAlpha);
	}

	public static void blitGui(PoseStack pose, ResourceLocation pAtlasLocation, int pX, int pY, int pBlitOffset, float pUOffset, float pVOffset, int pUWidth, int pVHeight, int pTextureWidth, int pTextureHeight, float pRed, float pGreen, float pBlue, float pAlpha) {
		blitGui(pose, pAtlasLocation, pX, pX + pUWidth, pY, pY + pVHeight, pBlitOffset, pUWidth, pVHeight, pUOffset, pVOffset, pTextureWidth, pTextureHeight, pRed, pGreen, pBlue, pAlpha);
	}

	public static void blitGui(PoseStack pose, ResourceLocation pAtlasLocation, int pX, int pY, int pWidth, int pHeight, float pUOffset, float pVOffset, int pUWidth, int pVHeight, int pTextureWidth, int pTextureHeight, float pRed, float pGreen, float pBlue, float pAlpha) {
		blitGui(pose, pAtlasLocation, pX, pX + pWidth, pY, pY + pHeight, 0, pUWidth, pVHeight, pUOffset, pVOffset, pTextureWidth, pTextureHeight, pRed, pGreen, pBlue, pAlpha);
	}

	public static void blitGui(PoseStack pose, ResourceLocation pAtlasLocation, int pX, int pY, float pUOffset, float pVOffset, int pWidth, int pHeight, int pTextureWidth, int pTextureHeight, float pRed, float pGreen, float pBlue, float pAlpha) {
		blitGui(pose, pAtlasLocation, pX, pY, pWidth, pHeight, pUOffset, pVOffset, pWidth, pHeight, pTextureWidth, pTextureHeight, pRed, pGreen, pBlue, pAlpha);
	}

	static void blitGui(PoseStack pose, ResourceLocation pAtlasLocation, int pX1, int pX2, int pY1, int pY2, int pBlitOffset, int pUWidth, int pVHeight, float pUOffset, float pVOffset, int pTextureWidth, int pTextureHeight, float pRed, float pGreen, float pBlue, float pAlpha) {
		innerBlitGui(pose, pAtlasLocation, pX1, pX2, pY1, pY2, pBlitOffset, (pUOffset + 0.0F) / (float)pTextureWidth, (pUOffset + (float)pUWidth) / (float)pTextureWidth, (pVOffset + 0.0F) / (float)pTextureHeight, (pVOffset + (float)pVHeight) / (float)pTextureHeight, pRed, pGreen, pBlue, pAlpha);
	}

	public static void innerBlitGui(PoseStack pose, ResourceLocation pAtlasLocation, int pX1, int pX2, int pY1, int pY2, int pBlitOffset, float pMinU, float pMaxU, float pMinV, float pMaxV, float pRed, float pGreen, float pBlue, float pAlpha) {
		RenderSystem.setShaderTexture(0, pAtlasLocation);
